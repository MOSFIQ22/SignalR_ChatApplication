...
namespace Messaging_with_FileSharing_Software.MessageHub
{
    public class MessageWithFileSharingHub:Hub
    {
        private static Dictionary<string, string> users = new Dictionary<string, string>();
        private readonly IWebHostEnvironment env;
        public MessageWithFileSharingHub(IWebHostEnvironment env)
        {
            this.env = env;
        }
